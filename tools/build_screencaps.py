...
def gallery_page(t: dict, frames: list[str], index: dict) -> str:
    ...
    .cap-empty{{padding:80px 0;text-align:center;color:#8c968f}}.cap-more{{display:block;margin:28px auto 0;background:#0e1412;border:1px solid #343c38;color:#eeeee8;padding:14px 28px;font:400 .62rem "DM Mono",monospace;letter-spacing:.14em;text-transform:uppercase;cursor:pointer}}
